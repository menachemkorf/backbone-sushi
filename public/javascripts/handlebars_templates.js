...
this["JST"]["cart_count"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
this["JST"]["product_details"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div><div class=\"nav prev\"><img src=\"../images/nav-prev.png\" alt=\"prev\"></div><figure><img src=\"../images/"
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.nutritian : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</tbody></table></aside><div class=\"nav next\"><img src=\"../images/nav-next.png\" alt=\"next\"></div></div>";
},"useData":true});

this["JST"]["product"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
